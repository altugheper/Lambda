...
public class Lambda01 {
    public static void main(String[] args) {
      ...
      4)  Lambda sadece collections'larda(List, Queue ve Set) ve array'lerde kullanilabilir ancak map'lerde kullanılmaz.
        ...
        */
        ...
        System.out.println();
        printCift34denKucukFunctional(sayi);
        System.out.println();
        printCift34denBuyukFunctional(sayi);
    }
    ...
    public static void printElFunctional1 (List<Integer> sayi){
        sayi.
                stream().
                forEach(System.out::print); //method reference. Buradaki sikinti, sayilar birlesik geliyor
    }
    ...
    public static void printElFunctional2 (List<Integer> sayi){
        sayi.
                stream().
                forEach(Lambda01::yazdir); //method reference //Lambda.yazdir().map
    }
    ...
    //Yukaridaki Task'i filter() kismini method reference ile yapalim
    ...
    //TASK  : Structural Programming ile list elemanlarinin
    // cift olanlarini ayni satirda aralarina bosluk birakarak print ediniz.
    ...
    public static void printCift34denKucukFunctional(List<Integer> sayi){
    ...
    public static void printCift34denBuyukFunctional(List<Integer> sayi){
        sayi.stream().filter(t->t%2==0 || t>34).forEach(Lambda01::yazdir);
    }
